...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"../node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n// import axios from '../../src/index'\r\n\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.request.use(function (config) {\r\n    config.headers.test += '1';\r\n    // return config\r\n}, function (error) {\r\n    console.log('请求拦截器 失败 - 1号');\r\n    console.log('内部' + error);\r\n    return Promise.reject(error);\r\n});\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.request.use(function (config) {\r\n    config.headers.test += '2';\r\n    // return config\r\n}, function (error) {\r\n    console.log('请求拦截器 失败 - 2号');\r\n    return Promise.reject(error);\r\n});\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.request.use(function (config) {\r\n    config.headers.test += '3';\r\n    //\r\n    // return Promise.reject('error')\r\n}, function (error) {\r\n    console.log('请求拦截器 失败 - 3号');\r\n    return Promise.reject(error);\r\n});\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.response.use(function (res) {\r\n    res.data += '1';\r\n    console.log('响应拦截器 成功 - 1号');\r\n    return res;\r\n});\r\nvar interceptor = axios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.response.use(function (res) {\r\n    console.log('响应拦截器 成功 - 2号');\r\n    res.data += '2';\r\n    return res;\r\n});\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.response.use(function (res) {\r\n    console.log('响应拦截器 成功 - 3号');\r\n    res.data += '3';\r\n    return res;\r\n});\r\naxios__WEBPACK_IMPORTED_MODULE_0___default.a.interceptors.response.eject(interceptor);\r\naxios__WEBPACK_IMPORTED_MODULE_0___default()({\r\n    url: '/interceptor/get',\r\n    method: 'get',\r\n    headers: {\r\n        test: '',\r\n    },\r\n}).then(function (res) {\r\n    console.log(res.data);\r\n}, function (err) {\r\n    console.log('调用' + err);\r\n});\r\n\n\n//# sourceURL=webpack:///./interceptor/app.ts?");

/***/ }),

/***/ 5:
/*!****************************************************************!*\
  !*** multi webpack-hot-middleware/client ./interceptor/app.ts ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! webpack-hot-middleware/client */\"../node_modules/webpack-hot-middleware/client.js\");\nmodule.exports = __webpack_require__(/*! D:\\study\\hdu-cs-learning\\项目\\ts-axios\\examples\\interceptor\\app.ts */\"./interceptor/app.ts\");\n\n\n//# sourceURL=webpack:///multi_webpack-hot-middleware/client_./interceptor/app.ts?");
